...
if (!empty($options['withmaster'])) {
    $workercmd = "php {$CFG->dirroot}/local/vmoodle/cli/init_mnet_node.php --bindhost=subs";
...
if ($allhosts) {
    foreach ($allhosts as $h) {
        $workercmd = "php {$CFG->dirroot}/local/vmoodle/cli/init_mnet_node.php --host=\"{$h->vhostname}\" --bindhost=\"{$CFG->mainwwwroot}\" ";
