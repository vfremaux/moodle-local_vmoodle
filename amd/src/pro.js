...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var localvmoodlepro = {
        ...
        component: 'local_vmoodle',
        shortcomponent: 'local_vmoodle',
        componentpath: '/local/vmoodle',

        init: function() {

            var licensekeyid = '#id_s_' + localvmoodlepro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + localvmoodlepro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = localvmoodlepro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + localvmoodlepro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + localvmoodlepro.component + '_licenseprovider').val();
