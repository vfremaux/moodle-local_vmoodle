 ...
 */
class Command_CheckStatus extends Command {
    ...
    public function __construct() {
        ...
        $cmd_name = vmoodle_get_string('cmdcheckname', 'vmoodleadminset_upgrade');
        $cmd_desc = vmoodle_get_string('cmdcheckdesc', 'vmoodleadminset_upgrade');
    ...
    public function run($hosts) {
        ...
        $rpcclient->set_method('local/vmoodle/plugins/upgrade/rpclib.php/mnetadmin_rpc_checkstatus');
