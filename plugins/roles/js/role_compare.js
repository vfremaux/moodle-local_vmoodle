 ...
 *
 * TODO : Possible rewrite in JQuery
 */
 ...
 * @param integer col   The column of capability
 * @param integer row   The row of capability.
 * @param string name   The name of capability.
 */
 ...
 * @param integer col   The column of current cell.
 * @param integer row   The row of current cell.
 */
 ...
 * @param DOM element el   A DOM element.
 * @param string clss   A CSS class name.
 */
