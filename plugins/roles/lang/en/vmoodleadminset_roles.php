...
$string['allowcompare'] = 'Role Allow tables comparison : {$a}';
...
<table style="width: 80%;">
  ...
  <tbody>
    ...
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/permissionallow.png" alt="Allow"/></td>
      <td>Means that capability is allowed.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/permissionprevent.png" alt="Prevent"/></td>
      <td>Means that capability is prevent.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/permissionforbid.png" alt="Forbid"/></td>
    ...
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/contextB.png" alt="Block Context"/></td>
      <td>Means that capability is "block" context.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/contextC.png" alt="Course Context"/></td>
      <td>Means that capability is "course" context.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/contextCC.png" alt="Categroy Context"/></td>
      <td>Means that capability is "course category" context.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/contextM.png" alt="Module Context"/></td>
      <td>Means that capability is "module" context.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/contextS.png" alt="System Context"/></td>
      <td>Means that capability is "system" context.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/contextU.png" alt="User Context"/></td>
    ...
    <tr>
      <td><img src="/local/vmoodle/plugins/roles/pix/norolecapability.png" alt="No capability set for role"/></td>
      <td>Means that capability is not set for this role.</td>
    </tr>
    <tr>
      <td><img src="/local/vmoodle/plugins/libs/rolelib/pix/nocapability.png" alt="No capability"/></td>
    ...
    <tr>
      <td style="background-color: #F2FF98;"><img src="/local/vmoodle/plugins/roles/pix/blank.png" alt="Context mismatch for capability"/></td>
      <td>Means that capability has different context than others platforms.</td>
    </tr>
    <tr>
      <td style="background-color: #FF607D;"><img src="/local/vmoodle/plugins/roles/pix/blank.png" alt="Value mismatch for capability"/></td>
