...
$subscribes = array(
    'mnetadmin' => array(
        ...
        'mnetadmin_rpc_create_user' => 'local/vmoodle/plugins/roles/rpclib.php/mnetadmin_rpc_create_user',
        'mnetadmin_rpc_remote_enrol' => 'local/vmoodle/plugins/roles/rpclib.php/mnetadmin_rpc_remote_enrol',
    ),
);
