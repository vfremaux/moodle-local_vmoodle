...
$string['cmdplugin'] = 'Copier une configuration de plugin';
$string['cmdplugin_desc'] = 'Copie la configuration locale du plugin sur un ensemble d\'instances';
$string['cmdpluginconfigvalue'] = 'Synchroniser un réglage de plugin';
$string['cmdpluginconfigvalue_desc'] = 'Distribue une valeur de configuration d\'un plugin';
$string['cmdcopyfilearea'] = 'Copier une zone de fichiers système';
$string['cmdcopyfilearea_desc'] = 'Copie une zone complète de fichiers, en reconstruisant sa structure.';
$string['cmdpurgecaches'] = 'Purger les caches';
$string['cmdpurgecaches_desc'] = 'Purge  les caches d\'un ensemble d\'instances';
$string['cmdsyncdesc'] = 'Synchronise les fichiers de modification du paquetage de langue.';
$string['cmdsyncname'] = 'Customisation des langues';
$string['configkey'] = 'Clef de configuration';
$string['configvalue'] = 'Valeur de configuration';
$string['core'] = 'Composants centraux';
$string['dataexchange_name'] = 'Echange de données';
$string['file_desc'] = 'Fichier système';
...
du réseau à partir de cette plate-forme.<br/><br/>';

$string['dataexchange_description'] = 'Ouvre des fonctions permettant l\'échange de données texte de configuration simple entre systèmes ';
