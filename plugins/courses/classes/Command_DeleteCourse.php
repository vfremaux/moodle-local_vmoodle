 ...
 */
class Command_DeleteCourse extends Command {
    ...
    public function __construct() {
        ...
        $name = vmoodle_get_string('cmddeletecourse', 'vmoodleadminset_courses');
    ...
    public function run($hosts) {
        ...
        if (!has_capability('local/vmoodle:execute', \context_system::instance())) {
            throw new Command_DeleteCourse_Exception('insuffisantcapabilities');
        }
