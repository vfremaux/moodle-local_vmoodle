 ...
 */
class Command_EmptyCourseCategory extends Command {
    ...
    public function __construct() {
        ...
        $name = vmoodle_get_string('cmdemptycoursecategory', 'vmoodleadminset_courses');
        $description = vmoodle_get_string('cmdemtycoursecategory_desc', 'vmoodleadminset_courses');
    ...
    public function run($hosts) {
        ...
        if (!has_capability('local/vmoodle:execute', \context_system::instance())) {
            throw new Command_EmptyCourseCategory_Exception('insuffisantcapabilities');
        }
        ...
        $rpcclient->set_method('local/vmoodle/plugins/courses/rpclib.php/mnetadmin_rpc_empty_course_category');
