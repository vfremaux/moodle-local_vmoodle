...
/**
 * Describes meta-administration plugin's command for checking course existance.
 *
 ...
 */
class Command_CheckCourse extends Command {
    ...
    public function __construct() {
        ...
        $name = vmoodle_get_string('cmdcheckcourse', 'vmoodleadminset_courses');
        $description = vmoodle_get_string('cmdcheckcourse_desc', 'vmoodleadminset_courses');

        $parameters[] = new Command_Parameter(
            'shortname',
            'text',
            get_string('byshortname', 'vmoodleadminset_courses'),
            null,
            null);
        ...
        $parameters[] = new Command_Parameter(
            'fullname',
            'text',
            get_string('infullname', 'vmoodleadminset_courses'),
            null,
            null,
            array('size' => 80));
        ...
        $parameters[] = new Command_Parameter(
            'idnumber',
            'text',
            get_string('byidnumber', 'vmoodleadminset_courses'),
            null,
            null);
    ...
    public function run($hosts) {
        ...
        if (!has_capability('local/vmoodle:execute', \context_system::instance())) {
            throw new Command_CheckCourse_Exception('insuffisantcapabilities');
        }
        ...
        $rpcclient->set_method('local/vmoodle/plugins/courses/rpclib.php/mnetadmin_rpc_check_course');
