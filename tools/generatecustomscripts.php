 ...
 */
require('../../../config.php');
require_once($CFG->dirroot.'/local/vmoodle/tools/customscriptgenerator_form.php');
require_once($CFG->dirroot.'/local/vmoodle/tools/lib.php');

$url = new moodle_url('/local/vmoodle/tools/generatecustomscripts.php');
...
if ($data = $mform->get_data()) {
    ...
    echo $OUTPUT->heading(get_string('generatedscript', 'local_vmoodle'));
    echo '<pre>';
    echo $script;
    echo '</pre>';
}
