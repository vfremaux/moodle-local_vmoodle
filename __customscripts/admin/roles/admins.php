...
require_once($CFG->dirroot.'/customscripts/admin/roles/classes/admins_potential_selector.php');
...
$potentialadmisselector = new custom_role_admins_potential_selector();
